var info = {
    ...
    "olivo" : {
        ...
        "about": "Rafael Sam G. Olivo, also known as 'Raf', is a 1st year BS Computer Science student. He is a 19-year old Rizaleño who loves to play volleyball and online games.<br><br>Rafael loves UPLB as the beauty of the campus captivated him during his first visit. He quickly fell in love with the serene atmosphere and refreshing breeze of the university.",
    ...
    "eugenio" : {
        ...
        "title": "SAKBAYAN",
        "piece": "<img src='./assets/visual/eugenio/work.jpg'>",
    ...
    "tan" : {
        "artist": "Miguel Tan",
        "about": "MIGUEL G. TAN, a third-year Doctor of Veterinary Medicine student at the University of the Philippines Los Banos (UPLB), Laguna.<br><br>He was born on July 21, 2003, and raised in Manila.",
    ...
    "tuazon2" : {
        ...
        "profile": "./assets/visual/tuazon2/icon.jpg",
        "title": "A lonely crater in a lonely moon",
        "piece": "<img src='./assets/visual/tuazon2/work.jpg'>",
        "description": "translate, binary to ascii",
    },
    "shi" : {
    ...
    "tandang" : {
        ...
        "description": "This visual artwork is a digital painting that combines various digital watercolor elements featuring graphic elements that depict the famous Vịnh Hạ Long, or Halong Bay, in Vietnam. As I considered how to approach this project, I came across a photo I took during my visit to Vietnam in 2023. Among the numerous breathtaking places I visited there, Halong Bay remains the most memorable place to me. The calm beauty of the limestone karsts rising from the emerald waters left a lasting mark on me. More importantly, the joyful moments I shared together with my family during that trip make this place more meaningful to me.<br><br>Nonetheless, this artwork is more than just a sentimental digital art piece for me; the painting's water flows convey a deeper message about how science profoundly impacts not only society but also other facets of life. The flowing water symbolizes the growth, expansion, versatility, and wide-ranging influence of science. Just as water alters the landscapes and places it touches, science continuously also transforms the world—pushing boundaries and enabling development. In line with this, this transformation can influence human creativity and artistic expression, so it also extends beyond the physical. This digital watercolor technique is an immediate product of the confluence of science and art, imaging how these two disciplines intertwine to showcase one’s creativity. Similar to how water represents life and sustenance, scientific advancements \"flow\" through societies, influencing not only infrastructure, technology, and culture but also how we use art to tell stories and convey our feelings. Halong Bay, with its timeless natural beauty, serves as a perfect subject to convey these ideas. The painting's dynamic flow of waters symbolizes both the deep connection between creativity, nature, and humanity, as well as the never-ending flow of innovation and discoveries in science and the arts. In this piece, I aim to show that art and science are not isolated fields. They can be interdependent forces that support and encourage one another to deepen our understanding of the world and our role in it.",
    },
    "oliveros" : {
        "artist": "Franco Gabriel P. Oliveros",
        "about": "Franco “Coco” Gabriel P. Oliveros is a digital illustrator with an anime/ manga illustration style. He was born on October 26, 2006 and grew up in Calamba City, Laguna.<br><br>As he grew up, he also grew to love watching anime and reading manga. This inspired Coco to try and learn to draw in a similar artstyle. Up to this day, despite pursuing a degree in Computer Science, he still desires to improve and explore more of the art that he loves.",
        "profile": "./assets/visual/oliveros/icon.png",
        "title": "Interlaced With Eternity",
        "piece": "<img src='./assets/visual/oliveros/work.png'>",
        "description": "“Amidst all the time that passes, chaos that destroys, and modernization that causes change, nature will still find its way to prevail.” As our world progresses, there will eventually be a time where the inevitable destruction will befall our world. In the art piece “Interlaced with Eternity”, the setting of such a world and its aftermath is portrayed. Within this setting, a girl gently holds a small, sprouting seed in a post-apocalyptic world. Despite the passage of eternal time, changes brought by modernization, and destruction resulted by chaos, traces of nature will still remain. A single ray of light highlights the seed, symbolizing nature’s persistence amidst a polluted, weathered, and desolate world. This light emphasizes that in a dark and desaturated world, a single seed can be a beacon of hope that can potentially bestow Earth its former bright and diverse colors. ",
    },
    "embudo" : {
        "artist": "Emmanuel D. Embudo",
        "about": "Emmanuel Embudo is a freshman BS Computer Science student at the University of the Philippines Los Baños. Despite not being artistically gifted, Emman continues to showcase his interest with architectural design.",
        "profile": "./assets/visual/embudo/icon.jpeg",
        "title": "Nature of Symmetry",
        "piece": "<img src='./assets/visual/embudo/work.jpg'>",
        "description": "It’s a modern oasis where the best of human design meets the timeless serenity of nature. This art piece showcases the use of science in bringing harmony and balance to architectural structures. Symmetry of measurements and angles provides balance, making the art more pleasing. With the minimalist colors of the house and the natural spectrum brought by nature, harmony is achieved. Despite the innovation of modern architectural structures, this artwork shows how modern architecture can coalesce with nature.",
    },
    "ortiz" : {
        "artist": "Denise Lauren P. Ortiz",
        "about": "Denise Lauren P. Ortiz, a second-year BS Statistics student at the University of the Philippines - Los Baños, draws inspiration from her late uncle, who nurtured her early love for art. Growing up, she developed a deep passion for creating artworks, particularly sketches and paintings. During her high school years, she actively participated in poster and slogan-making contests, honing her creative skills and eye for detail.<br><br>Her art often reflects her admiration for nature's splendor, as she frequently chooses landscapes and plants as her primary subjects. Through her pieces, she aims to capture the intricate beauty and serenity of the natural world, blending her artistic vision with her appreciation for the environment.",
        "profile": "./assets/visual/ortiz/icon.png",
        "title": "緑 (Midori)",
        "piece": "<img src='./assets/visual/ortiz/work.jpg'>",
        "description": "Leaf impression painting, a nature-inspired and eco-conscious art form, utilizes real leaves to produce intricate patterns and designs on surfaces like paper, fabric, canvas, or walls. This art form not only brings natural beauty into creative expression but also highlights the fascinating relationship between science and art. By using plant leaves as stamps or patterns, leaf impression painting reveals the unique structures and vein patterns of each leaf, emphasizing the biological diversity found in nature.<br><br>The Japanese word “Midori”, meaning 'green' in English, beautifully symbolizes how people, like a cluster of green leaves, grow and thrive together, enduring both the storms and the sunlight that life brings. Just as leaves depend on one another within the canopy of a tree, people also rely on their connections to flourish. Leaves, when working together, create shade, oxygen, and a vibrant ecosystem, much like how humans, through harmony and collaboration, build communities, support systems, and shared progress. Both leaves and people remind us of the strength found in unity and the beauty of collective growth.",
    },
    "serrano" : {
        "artist": "Deigna Phoebe Marie P. Serrano",
        "about": "DEIGNA PHOEBE MARIE P. SERRANO is a first-year student of Bachelor of Science in Computer Science in the University of the Philippines Los Baños (UPLB). Aside from her academics and interests in tech-related things, art has been a fascination and a hobby of hers since her youth. Painting and drawing have been a continuous hobby of hers, also enthusiastically studying artworks of other renowned artists to improve and flourish her skills. With modern technology, she continuously improves herself, especially in the field of digital art.",
        "profile": "./assets/visual/serrano/icon.jpg",
        "title": "Fading into Soullessness",
        "piece": "<img src='./assets/visual/serrano/work.jpg'>",
        "description": "AI art has been observably prevalent in the present era. One way people have utilized this technology is through the use of artificial intelligence to generate artworks using prompts. However, as time passes, these machines improve the generation of these images and efforts put on artworks are getting more depreciated and devalued. AI artworks have become mainstream, but something is missing in these artworks. It is the human touch, the essence that which you can only perceive from artworks done by the hand of an artist. The essence, which is absent in artworks generated by a machine piecing together images referencing millions of artworks fed to generative AI without knowledge of its human creators. This piece illustrates the absence of that “soul” in generative artworks, and the waning appreciation for human-created art.",
    },
    "gonzales" : {
        "artist": "Dash Gonzales",
        "about": "Dash Matthew C. Gonzales is a computer science student at the university of the Philippines Los Baños, with a very casual interest in drawing. He only really draws in moments of inspiration as most of his time is taken up by his academic pursuits and passion for video games, anime and manga.",
        "profile": "./assets/visual/gonzales/icon.png",
        "title": "Memories in Code and Canvas",
        "piece": "<img src='./assets/visual/gonzales/work.png'>",
        "description": "It is nature for science and art to intertwine, shaping how people create and innovate. 'Memories in Code and Canvas' is a comic inspired by the time in senior high school where my class was tasked to make an app. I was groupmates with my closest friends and it's become a memory I will never forget. While some of us focused on the coding aspect of the app, the others brought life to our code with their designs on the user interface; this showcases just how important art is to science and technology as without thoughtful design, even the most functional app may lack appeal or usability.",
    },
    "de leon" : {
        "artist": "Chastelle Marx V. De Leon",
        "about": "Chastelle Marx De Leon, also known as 'Cha', is a 2nd year BS Biology student at the University of the Philippines Los Baños. She is originally from Camarines Sur, Bicol, and later moved to Los Baños to pursue her studies.<br><br>She is very passionate about anything related to nature, which fuels her curiosity about life sciences. Her journey to explore biology has led to a deeper understanding and appreciation of life",
        "profile": "./assets/visual/de leon/icon.jpg",
        "title": "In every step we take",
        "piece": "<img src='./assets/visual/de leon/work.jpg'>",
        "description": "The artwork is a poignant reminder of our current situation in the marine environment, in which despite the increasing influence of technology in society, it continues to cause severe damage to ecosystems, particularly aquatic life, where thousands of animals and plants are affected by the devastating effects of industrial pollution. <br><br>While the impact of the manufacturing industry in providing innovative technologies is essential and significant, environmental issues arise. This underscores the need for advancements that can also protect our nature ensuring that sustainability is prioritized. <br><br>As part of humanity, it is our responsibility to practice stewardship in how we interact with the environment, emphasizing how we must be able to preserve the natural world for future generations. Through awareness and cooperation, we  harness our ability to empathize with and respect all forms of life, fostering a deeper relationship with the natural entities that provide us with resources essential for our survival.",
    },
    "paguirigan" : {
        "artist": "Braedan Anthony Jorge H. Paguirigan",
    ...
    "angeles" : {
        "artist": "Angela Mae Angeles",
        "about": "Angela Mae Angeles, a second-year BS Statistics student, is a seasonal artist with a passion for digital art. With a desire for showcasing the beauty of nature, her work often features soft colors and serene landscapes.<br><br>Born in Nagcarlan, a culturally rich town in Laguna, Angela grew up surrounded by the lush beauty of nature. This connection deeply influences her artistic vision, making her pieces often evoke deep reflection and celebrate the serenity and beauty of the natural world.",
        "profile": "./assets/visual/angeles/icon.jpg",
        "title": "Walk Under the Twilight Sky",
        "piece": "<img src='./assets/visual/angeles/work.png'>",
        "description": "In the midst of bustling cities and the fast-paced advancements of our society, Walk Under the Twilight Sky offers a moment of peace and tranquility, reminding us of a quiet and simple life while showcasing the beauty of nature.<br><br>The scene encourages us to appreciate nature’s beauty and ground ourselves in the present. Even though science and technology continue to push us forward, our connection with the natural world should not be severed; rather, it should serve as a tool for deeper understanding and harmony with nature.<br><br>In our current world, where technology influences every aspect of our lives, Walk Under the Twilight Sky reminds us that scientific and technological progress can go side by side in harmony with nature. We can walk a path that embraces innovation and advancements while preserving nature. This piece of art invites you to see a future where science and technology not only push us forward but also deepen our love and respect for the environment that gives us life and sustains us.",
    },
}
